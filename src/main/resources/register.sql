DROP TABLE IF EXISTS cr_address_person; --lvl 0 -- удаляется первым (нет таблиц которые берут отсюда данные для своих полей
DROP TABLE IF EXISTS cr_address;        --lvl 1 -- удаляется после удаления lvl0, потому что lvl0 пользуется её полями и т.д.
DROP TABLE IF EXISTS cr_district;       --lvl 2
DROP TABLE IF EXISTS cr_street;         --lvl 2
DROP TABLE IF EXISTS cr_person;         --lvl 1
...
INSERT INTO cr_person (sur_name, given_name, patronymic_name, date_of_birth, passport_seria,
passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Vasiliev', 'Pavel', 'Nikolaevich', '1995-03-18', '1234', '123456', '2015-04-11', null, null);
...
INSERT INTO cr_person (sur_name, given_name, patronymic_name, date_of_birth, passport_seria,
passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Vasilieva', 'Evgenia', 'Pavlovna', '2016-01-01', null, null, null, '456123', '2016-01-21');

INSERT INTO cr_person (sur_name, given_name, patronymic_name, date_of_birth, passport_seria,
passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Vasiliev', 'Aleksandr', 'Pavlovich', '2018-10-24', null, null, null, '321654', '2018-11-09');
